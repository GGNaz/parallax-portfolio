  ...
  return (
    <div >
      <Parallax pages={2}>
        ...
        >
          ...
          <div className="flex h-screen">
            ...
            <div className="md:flex md:basis-3/6 lg:basis-2/5 hidden relative justify-center">
              <ParallaxLayer  offset={0} speed={1} horizontal={true} className="-z-10 ">
                <div className="bg-[#28292D] h-[80vh] w-[80vh] -z-10 bottom-0 inset-16 absolute shadow-lg rounded-full"></div>
              </ParallaxLayer>
              <ParallaxLayer  offset={0} speed={0.7} className="z-10">
                <Image
                  src={tailwindIcon}
                  alt="tailwindIcon"
                  className="absolute bottom-64 right-10 h-24 w-24 bg-[#333438] shadow-lg z-10 p-2 rounded-full"
                />
              </ParallaxLayer>
              <ParallaxLayer offset={0} speed={1} className="z-10 ">
                <Image
                  src={tailwindIcon}
                  alt="reactIcon"
                  className="absolute bottom-28 left-10 h-20 w-20 bg-[#333438] shadow-lg z-10 p-4 rounded-full"
                />
              </ParallaxLayer>
              <ParallaxLayer offset={0} speed={0.8} className="md:z-10">
        ...
        <ParallaxLayer offset={0.999} speed={1} style={{ backgroundColor: "red" }}>
